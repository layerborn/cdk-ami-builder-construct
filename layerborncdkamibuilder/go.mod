module github.com/layerborn/cdk-ami-builder-construct/layerborncdkamibuilder

go 1.18

require (
	github.com/aws/jsii-runtime-go v1.94.0
	github.com/layerborn/cdk-iam-policy-builder-helper-construct/layerborncdkiampolicybuilderhelper v0.0.1
	github.com/aws/aws-cdk-go/awscdk/v2 v2.126.0
	github.com/aws/constructs-go/constructs/v10 v10.1.203
